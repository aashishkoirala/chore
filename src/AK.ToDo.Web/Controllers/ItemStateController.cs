/*******************************************************************************************************************************
 * AK.To|Do.Web.Controllers.ItemStateController
...
{
    /// <summary>
    /// Web API controller for "/itemstate" - lets the client get the list of possible item states.
    /// </summary>
    /// <author>Aashish Koirala</author>
    [Export, PartCreationPolicy(CreationPolicy.NonShared), WebApiAuth, ServiceExceptionFilter]
    public class ItemStateController : ApiController, IUserAwareController
    {
        ...
        public IList<Tuple<string, string>> Get()        
        {
            ...
            //
            return this.lookupService.GetItemStateList()
