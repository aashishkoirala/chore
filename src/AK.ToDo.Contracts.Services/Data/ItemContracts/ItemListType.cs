/*******************************************************************************************************************************
 * AK.To|Do.Contracts.Services.Data.ItemContracts.ItemListType
...
{
    /// <summary>
    /// Different types of item list criteria. "Other" is special in that it requires other filters to be specified.
    /// </summary>
